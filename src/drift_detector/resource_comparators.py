...
def compare_attributes(
    ...
    if resource_type.startswith('aws_instance'):
        ...
        drift_details.extend(_compare_eventbridge_bus_attributes(state_attrs, live_attrs))
    elif resource_type.startswith('aws_cloudwatch_event_rule'):
        drift_details.extend(_compare_eventbridge_rule_attributes(state_attrs, live_attrs))
        ...
        drift_details.extend(_compare_cloudwatch_dashboard_attributes(state_attrs, live_attrs))
    elif resource_type.startswith('aws_cloudwatch_metric_alarm'):
        drift_details.extend(_compare_cloudwatch_alarm_attributes(state_attrs, live_attrs))
